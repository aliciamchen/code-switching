...
```{r}
selection_trials <- read_csv(here("data", "pilot-1_2024-09-17", "selection_trials.csv"))
```
...
Calculating means is probably not the best way to visualize this but it's ok for now
...
```{r}
exit_survey <- read_csv(here("data", "pilot-1_2024-09-17", "exit_survey.csv"))
```
