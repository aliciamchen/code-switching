...
macros <- macros |>
  ...
  add_macros("expOneLengthSocialLin", trend_macros(trends_length, "linear", "social")) |>
  add_macros("expOneLengthSocialQuad", trend_macros(trends_length, "quadratic", "social"))
```
