...
social_trend <- function(deg) trends_df[trends_df$goal == "social" & trends_df$degree == deg, ]
...
macros$expFourSocialLinB <- fmt_num(social_trend("linear")$prop_outgroup.trend)
macros$expFourSocialLinZ <- fmt_num(social_trend("linear")$z.ratio)
macros$expFourSocialLinP <- fmt_p(social_trend("linear")$p.value)
macros$expFourSocialQuadB <- fmt_num(social_trend("quadratic")$prop_outgroup.trend)
macros$expFourSocialQuadZ <- fmt_num(social_trend("quadratic")$z.ratio)
macros$expFourSocialQuadP <- fmt_p(social_trend("quadratic")$p.value)
```
