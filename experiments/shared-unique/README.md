# Shared vs. unique (Experiment 2)

This experiment tests whether participants choose tangrams with shared or group-specific labels, depending on their audience and goal. This folder contains the jsPsych experiment code, and `stim/` contains the stimuli and randomization along with the scripts that generate them.
